...
public class ShiroProperties {
	 ...
	 */
	private String authResourcePrefix = "/credit/,/common/,/data/";
	
	/**
	 * 登录URL
	 */
	private String loginUrl = "/credit/login";
	
	/**
	 * 登出URL
	 */
	private String logoutUrl = "/credit/logout";
	
	/**
	 * 登录成功跳转URL
	 */
	private String successUrl = "/credit/index";
