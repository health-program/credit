...
window.BMAP_AUTHENTIC_KEY = "sSelQoVi2L3KofLo1HOobonW";
(function () {
    function ba(a) {
        throw a;
    }
    ...
    /(\d+\.\d)?(?:\.\d)?\s+safari\/?(\d+\.\d+)?/i.test(ka) && !/chrome/i.test(ka) && (x.da.iF = +(RegExp.$1 ||
        RegExp.$2));
    ...
    x.VK = function () {
        function a(a) {
            document.addEventListener && (this.element = a, this.YK = this.zk ? "touchstart" : "mousedown",
                this.oD = this.zk ? "touchmove" : "mousemove", this.nD = this.zk ? "touchend" : "mouseup",
                this.oh = q, this.hu = this.gu = 0, this.element.addEventListener(this.YK, this, q), ia.M(
                    this.element, "mousedown", s()), this.handleEvent(p))
        }
        a.prototype = {
            ...
            move: function (a) {
                ...
                if (10 < Math.abs((this.zk ? a.touches[0].clientX : a.clientX) - this.gu) || 10 < Math.abs(
                        c - this.hu)) this.oh = o
            },
            end: function (a) {
                na(a);
                this.oh || (a = document.createEvent("Event"), a.initEvent("tap", q, o), this.element.dispatchEvent(
                    a));
    ...
    z.XU = z.apiLoad || function () {
        z.version && z.version >= 1.5 && oa(z.wc + "?qt=verify&ak=" + pa, function (a) {
            if (a && a.error !== 0) {
                ...
                z = p;
                var b =
                    "\u767e\u5ea6\u672a\u6388\u6743\u4f7f\u7528\u5730\u56feAPI\uff0c\u53ef\u80fd\u662f\u56e0\u4e3a\u60a8\u63d0\u4f9b\u7684\u5bc6\u94a5\u4e0d\u662f\u6709\u6548\u7684\u767e\u5ea6LBS\u5f00\u653e\u5e73\u53f0\u5bc6\u94a5\uff0c\u6216\u6b64\u5bc6\u94a5\u672a\u5bf9\u672c\u5e94\u7528\u7684\u767e\u5ea6\u5730\u56feJavaScriptAPI\u6388\u6743\u3002\u60a8\u53ef\u4ee5\u8bbf\u95ee\u5982\u4e0b\u7f51\u5740\u4e86\u89e3\u5982\u4f55\u83b7\u53d6\u6709\u6548\u7684\u5bc6\u94a5\uff1ahttp://localhost:8480/lbsyun.baidu.com/apiconsole/key#\u3002";
                switch (a.error) {
                    case 101:
                        b =
                            "\u5f00\u53d1\u8005\u7981\u7528\u4e86\u8be5ak\u7684jsapi\u670d\u52a1\u6743\u9650\u3002\u60a8\u53ef\u4ee5\u8bbf\u95ee\u5982\u4e0b\u7f51\u5740\u4e86\u89e3\u5982\u4f55\u83b7\u53d6\u6709\u6548\u7684\u5bc6\u94a5\uff1ahttp://localhost:8480/lbsyun.baidu.com/apiconsole/key#\u3002";
                        break;
                    case 102:
                        b =
                            "\u5f00\u53d1\u8005Referer\u4e0d\u6b63\u786e\u3002\u60a8\u53ef\u4ee5\u8bbf\u95ee\u5982\u4e0b\u7f51\u5740\u4e86\u89e3\u5982\u4f55\u83b7\u53d6\u6709\u6548\u7684\u5bc6\u94a5\uff1ahttp://localhost:8480/lbsyun.baidu.com/apiconsole/key#\u3002"
                }
                alert(b)
            }
        })
    ...
    x.extend(Ka.prototype, {
        ...
        hk: function (a, b, c, d) {
            ...
            if (c = c && d ? f.Ck(c, this.Xb) : this.mc)
                if (this.mc = new H(c.lng + a * e, c.lat - b * e), (a = f.nh(this.mc, this.Xb)) && g)
                    this.Oe = a
        },
        Cg: function (a, b) {
            if (Wa(a) && (this.Vu(), this.dispatchEvent(new M("onzoomstart")), a = this.Wn(a).zoom, a !==
                    this.Oa)) {
                this.Lc = this.Oa;
                this.Oa = a;
                var c;
                b ? c = b : this.gh() && (c = this.gh().ha());
                c && (c = this.bc(c, this.Lc), this.hk(this.width / 2 - c.x, this.height / 2 - c.y,
                    this.wb(c, this.Lc), o));
        ...
        ui: function (a) {
            a instanceof H && (this.mc = this.ie.Ck(a, this.Xb), this.Oe = H.fM(a) ? new H(a.lng, a.lat) :
        ...
        Vf: function (a) {
            ...
            if (a instanceof H) b.ui(a, {
                ...
                if (b.Jb === Pa) {
                    ...
                    var d = this.JH();
                    d.wF(function (c) {
                        0 === d.zm() && 2 === d.Fa.result.type && (b.Vf(c.xk(0).point), Pa.tk(a) &&
                            b.qF(a))
                    });
                    d.search(a, {
                        log: "center"
        ...
        Bb: function () {
            return this.rs && this.rs instanceof L ? new L(this.rs.width, this.rs.height) : new L(this.Va
                .clientWidth, this.Va.clientHeight)
        },
        Ae: function (a) {
            a && a instanceof L ? (this.rs = a, this.Va.style.width = a.width + "px", this.Va.style.height =
                a.height + "px") : this.rs = p
        },
        Ha: u("Oe"),
        fa: u("Oa"),
        yV: function () {
        ...
        RR: function (a, b) {
            for (var c = this.oa(), d = b.margins || [10, 10, 10, 10], e = b.zoomFactor || 0, f = d[1] +
                    d[3], d = d[0] + d[2], g = c.Zo(), i = c = c.vm(); i >= g; i--) {
                var k = this.oa().yc(i);
        ...
        bt: function (a, b) {
            ...
            for (var b = b || {}, e = [], f = 0, g = d.length; f < g; f++) e.push(this.ie.Ck(d[f], this
                .Xb));
            d = new db;
            ...
            c = d.Ha();
            e = this.RR(d, b);
            b.margins && (d = b.margins, f = (d[1] - d[3]) / 2, d = (d[0] - d[2]) / 2, g = this.oa().yc(
        ...
        Tt: function (a) {
            ...
            if (a) {
                ...
                }, 50) : (this.D.xe = a, this.dispatchEvent(new M("onsetcustomstyles", a)), this.aM(
                    b.D.xe.geotableId));
                var c = {
                    style: a.style
                };
                ...
                Qa(5050, c);
                a.style && (c = b.D.gm[a.style] ? b.D.gm[a.style].backColor : b.D.gm.normal.backColor) &&
    ...
    z.VL = {
        TILE_BASE_URLS: ["localhost:8480/gss0.bdstatic.com/5bwHcj7lABFU8t_jkk_Z1zRvfdw6buu",
            "localhost:8480/gss0.bdstatic.com/5bwHcj7lABFV8t_jkk_Z1zRvfdw6buu",
            "localhost:8480/gss0.bdstatic.com/5bwHcj7lABFS8t_jkk_Z1zRvfdw6buu",
            "localhost:8480/gss0.bdstatic.com/5bwHcj7lABFT8t_jkk_Z1zRvfdw6buu",
            "localhost:8480/gss0.bdstatic.com/5bwHcj7lABFY8t_jkk_Z1zRvfdw6buu"],
        TILE_ONLINE_URLS: ["localhost:8480/gss0.bdstatic.com/8bo_dTSlR1gBo1vgoIiO_jowehsv",
            "localhost:8480/gss0.bdstatic.com/8bo_dTSlRMgBo1vgoIiO_jowehsv",
            "localhost:8480/gss0.bdstatic.com/8bo_dTSlRcgBo1vgoIiO_jowehsv",
            "localhost:8480/gss0.bdstatic.com/8bo_dTSlRsgBo1vgoIiO_jowehsv",
            "localhost:8480/gss0.bdstatic.com/8bo_dTSlQ1gBo1vgoIiO_jowehsv"],
        TIlE_PERSPECT_URLS: ["localhost:8480/gss0.bdstatic.com/-OR1cTe9KgQFm2e88IuM_a",
            "localhost:8480/gss0.bdstatic.com/-ON1cTe9KgQFm2e88IuM_a", "localhost:8480/gss0.bdstatic.com/-OZ1cTe9KgQFm2e88IuM_a",
            "localhost:8480/gss0.bdstatic.com/-OV1cTe9KgQFm2e88IuM_a"],
        geolocControl: "localhost:8480/gsp0.baidu.com/8LkJsjOpB1gCo2Kml5_Y_D3",
        TILES_YUN_HOST: ["localhost:8480/gsp0.baidu.com/-eR1bSahKgkFkRGko9WTAnF6hhy",
            "localhost:8480/gsp0.baidu.com/-eN1bSahKgkFkRGko9WTAnF6hhy", "localhost:8480/gsp0.baidu.com/-eZ1bSahKgkFkRGko9WTAnF6hhy",
            "localhost:8480/gsp0.baidu.com/-eV1bSahKgkFkRGko9WTAnF6hhy"],
        traffic: "localhost:8480/gsp0.baidu.com/7_AZsjOpB1gCo2Kml5_Y_DAcsMJiwa",
        iw_pano: "localhost:8480/gss0.bdstatic.com/5LUZemba_QUU8t7mm9GUKT-xh_",
        message: "localhost:8480/gsp0.baidu.com/7vo0bSba2gU2pMbgoY3K",
        baidumap: "localhost:8480/gsp0.baidu.com/80MWsjip0QIZ8tyhnq",
        wuxian: "localhost:8480/gsp0.baidu.com/6a1OdTeaKgQFm2e88IuM_a",
        pano: ["localhost:8480/gss0.bdstatic.com/5LUZemba_QUU8t7mm9GUKT-xh_", "localhost:8480/gss0.bdstatic.com/5LUZemfa_QUU8t7mm9GUKT-xh_",
            "localhost:8480/gss0.bdstatic.com/5LUZemja_QUU8t7mm9GUKT-xh_"],
        main_domain_nocdn: {
            baidu: "localhost:8480/gsp0.baidu.com/9_Q4sjOpB1gCo2Kml5_Y_D3",
            other: "localhost:8480/api.map.baidu.com"
        },
        main_domain_cdn: {
            baidu: ["localhost:8480/gss0.bdstatic.com/9_Q4vHSd2RZ3otebn9fN2DJv", "localhost:8480/gss0.baidu.com/9_Q4vXSd2RZ3otebn9fN2DJv",
                "localhost:8480/gss0.bdstatic.com/9_Q4vnSd2RZ3otebn9fN2DJv"],
            other: ["localhost:8480/api.map.baidu.com"],
            webmap: ["localhost:8480/gss0.baidu.com/6b1IcTe9R1gBo1vgoIiO_jowehsv"]
        },
        map_click: "localhost:8480/gsp0.baidu.com/80MWbzKh2wt3n2qy8IqW0jdnxx1xbK",
        vector_traffic: "localhost:8480/gss0.bdstatic.com/8aZ1cTe9KgQIm2_p8IuM_a"
    };
    z.$X = {
        TILE_BASE_URLS: ["localhost:8480/shangetu0.map.bdimg.com", "localhost:8480/shangetu1.map.bdimg.com", "localhost:8480/shangetu2.map.bdimg.com",
            "localhost:8480/shangetu3.map.bdimg.com", "localhost:8480/shangetu4.map.bdimg.com"],
        TILE_ONLINE_URLS: ["localhost:8480/online0.map.bdimg.com", "localhost:8480/online1.map.bdimg.com", "localhost:8480/online2.map.bdimg.com",
            "localhost:8480/online3.map.bdimg.com", "localhost:8480/online4.map.bdimg.com"],
        TIlE_PERSPECT_URLS: ["localhost:8480/d0.map.baidu.com", "localhost:8480/d1.map.baidu.com", "localhost:8480/d2.map.baidu.com", "localhost:8480/d3.map.baidu.com"],
        geolocControl: "localhost:8480/loc.map.baidu.com",
        TILES_YUN_HOST: ["localhost:8480/g0.api.map.baidu.com", "localhost:8480/g1.api.map.baidu.com", "localhost:8480/g2.api.map.baidu.com",
            "localhost:8480/g3.api.map.baidu.com"],
        traffic: "localhost:8480/its.map.baidu.com:8002",
        iw_pano: "localhost:8480/pcsv0.map.bdimg.com",
        message: "localhost:8480/j.map.baidu.com",
        baidumap: "localhost:8480/map.baidu.com",
        wuxian: "wuxian.baidu.com",
        pano: ["localhost:8480/pcsv0.map.bdimg.com", "localhost:8480/pcsv1.map.bdimg.com", "localhost:8480/pcsv2.map.bdimg.com"],
        main_domain_nocdn: {
            baidu: "localhost:8480/api.map.baidu.com"
        },
        main_domain_cdn: {
            baidu: ["localhost:8480/api0.map.bdimg.com", "localhost:8480/api1.map.bdimg.com", "localhost:8480/api2.map.bdimg.com"],
            webmap: ["localhost:8480/webmap0.map.bdimg.com"]
        },
        map_click: "mapclick.map.baidu.com",
        vector_traffic: "localhost:8480/or.map.bdimg.com"
    };
    z.Y_ = {
        "0": {
            proto: "http://",
    ...
    z.wc = z.url.proto + ("2" == z.Qy ? z.url.domain.main_domain_nocdn.other : z.url.domain.main_domain_nocdn.baidu) +
        "/";
    z.ma = z.url.proto + ("2" == z.Qy ? z.url.domain.main_domain_cdn.other[0] : z.url.domain.main_domain_cdn.baidu[
        0]) + "/";
    ...
    z.rg = function (a, b) {
        ...
        switch (a) {
            ...
            case "main_domain_cdn":
                ...
                break;
            default:
                d = z.url.domain[a], "[object Array]" == Object.prototype.toString.call(d) ? (c = [], x.kc.Gb(d,
                    function (a, d) {
                        c[d] = z.url.proto + a + "/" + b
    ...
    function tb(a) {
        var b = $a();
        b >= a.Yz ? (Xa(a.k.va) && a.k.va(a.k.jc(1)), Xa(a.k.finish) && a.k.finish(), 0 < a.Yf.length && (b = a.Yf[
            0], b.Yf = [].concat(a.Yf.slice(1)), b.start())) : (a.xy = a.k.jc((b - a.Nu) / a.k.duration), Xa(a.k
            .va) && a.k.va(a.xy), a.FF || (a.Wr = setTimeout(function () {
            tb(a)
        }, 1E3 / a.k.Gc)))
    }
    ...
    var F = {
        ...
        ZF: new L(13, 1),
        qa: z.ma + "images/",
        g3: "http://localhost:8480/api0.map.bdimg.com/images/",
        ...
        b.handle.click || (b.addEventListener("click", function (a) {
            for (var c = a.target || a.srcElement; c != b;) {
                Pb(b.Om, function (b, g) {
                    RegExp(g.filter).test(c.getAttribute("filter")) && g.qm.call(c, a, c.getAttribute(
                        "filter"))
                });
                c = c.parentNode
            }
    ...
    function (a, b, c) {
        ...
        function (a, b, c) {
            ...
            function k(a, b, c) {
                if (a) {
                    ...
                    try {
                        a == P ? (N[b] = N[b] || [], N[b].unshift(c)) : a.addEventListener ? a.addEventListener(b,
                            c, q) : a.attachEvent && a.attachEvent("on" + b, c)
                    } catch (d) {}
                }
            }
            ...
            if (!B || !B.Jo) {
                var A = b.all && a.attachEvent,
                    ...
                    P = function (a) {
                        ...
                        } else "function" == typeof a ? a(P) : ("" + a).replace(/^(?:([\w$_]+)\.)?(\w+)$/, function (
                            a, c, d) {
                            b[0] = d;
                            t.apply(P.OF(c), b)
                        })
        ...
        function (a, b, c) {
            var g = "18_1";
            G() && (g = "18_2");
            var i = "http://localhost:8480/static.tieba.baidu.com";
            "https:" === a.location.protocol && (i = "https://localhost:8480/gsp0.baidu.com/5aAHeD3nKhI2p27j8IqW0jdnxx1xbK");
            var k = Math.random,
            ...
            n && (n.xh && k() < n.xh) && (c.alog("cus.on", "time", function (a) {
                ...
                if ("[object Object]" === a.toString()) {
                    for (var g in a) "page" == g ? b.page = a[g] : (e = parseInt(a[g]), 0 < e && /^z_/.test(
                        g) && (d = o, b[g] = e));
                ...
                if (a instanceof Array)
                    for (var e = 0; e < a.length; e++) /^z_/.test(a[e]) ? (d = o, b[a[e]] = 1) :
            ...
            if (t && t.xh && k() < t.xh) {
                var A = ["Moz", "O", "ms", "Webkit"],
                    E = ["-webkit-", "-moz-", "-o-", "-ms-"],
                    C = function () {
                        return typeof b.createElement !== "function" ? b.createElement(arguments[0]) : b.createElement
                            .apply(b, arguments)
                    },
                    ...
                    gd = function () {
                        return !(!Array.prototype || !Array.prototype.every || !Array.prototype.filter || !Array.prototype
                            .forEach || !Array.prototype.indexOf || !Array.prototype.lastIndexOf || !Array.prototype
                            .map || !Array.prototype.some || !Array.prototype.reduce || !Array.prototype.reduceRight ||
                            !Array.isArray)
                    },
                    te = function () {
                        return "Promise" in a && "cast" in a.lq && "resolve" in a.lq && "reject" in a.lq && "all" in
                            a.lq && "race" in a.lq && function () {
                                var b;
                                new a.lq(function (a) {
                                    b = a
                                });
                    ...
                    oi = function () {
                        return !!a.webkitNotifications || "Notification" in a && "permission" in a.vP &&
                            "requestPermission" in a.vP
                    },
                    pi = function () {
                ...
                v.M("commit", function () {
                    ...
                    var a = setInterval(function () {
                        if ("WebP-lossy" in Mb.ii && "WebP-lossless" in Mb.ii && "WebP-alpha" in Mb
                            .ii && "WebP-animation" in Mb.ii) {
    ...
    x.object.extend(I, {
        ...
        lK: function (a) {
            if (a && this.rL()[a])
                for (var a = this.rL()[a], b = 0; b < a.length; b++) this.lK(a[b]), this.Pd.ul[a[b]] ||
                    this.zN(a[b])
        },
        zN: function (a) {
        ...
        vV: function (a, b) {
            for (var c = this.Pd.Tv, d = o, e = 0, f = c.length; e < f; e++) "" == c[e].KE && (c[e].TM ==
                a ? c[e].KE = b : d = q);
            d && this.XK()
        },
        XK: function () {
    ...
    function gb(a, b) {
        a && (this.Mb = a, this.ba = "spot" + gb.ba++, b = b || {}, this.Sg = b.text || "", this.zv = b.offsets ? b
            .offsets.slice(0) : [5, 5, 5, 5], this.uJ = b.userData || p, this.Qh = b.minZoom || p, this.Ef = b.maxZoom ||
            p)
    }
    gb.ba = 0;
    ...
    x.extend(Sb.prototype, {
        ...
        remove: function () {
            this.C = p;
            this.B && (this.B.parentNode && this.B.parentNode.removeChild(this.B), this.B = this.B.mr =
                p)
        },
        Aa: function () {
    ...
    x.object.extend(Xb.prototype, {
        ...
        FD: u("dc"),
        bF: function (a) {
            for (var b = 0, c = this.dc.length; b < c; b++) this.dc[b].id == a && (r = this.dc.splice(b,
                1), b--, c = this.dc.length)
        },
        Ce: function () {
            var a = this;
    ...
    x.object.extend(cc.prototype, {
        ...
        removeItem: function (a) {
            if (a && "menuitem" == a.Nb) {
                for (var b = 0, c = this.ya.length; b < c; b++) this.ya[b] === a && (this.ya[b].remove(),
                    this.ya.splice(b, 1), c--);
                b = 0;
                for (c = this.Hf.length; b < c; b++) this.Hf[b] === a && (this.Hf[b].remove(), this.Hf.splice(
                    b, 1), c--)
            }
        },
        SB: function () {
        ...
        dF: function (a) {
            if (this.Ee[a]) {
                for (var b = 0, c = this.ya.length; b < c; b++) this.ya[b] && ("divider" == this.ya[b].Nb &&
                    this.ya[b].Nj == a) && (this.ya.splice(b, 1), c--), this.ya[b] && ("divider" ==
                    this.ya[b].Nb && this.ya[b].Nj > a) && this.ya[b].Nj--;
                this.Ee.splice(a, 1)
            }
        },
        Id: u("B"),
    ...
    x.object.extend(db.prototype, {
        ...
        nf: u("xl"),
        JV: function (a) {
            return !(a instanceof db) || this.xj() || a.xj() ? q : a.Le > this.Le && a.He < this.He &&
                a.Xd > this.Xd && a.Vd < this.Vd
        },
        Ha: function () {
            return this.xj() ? p : new H((this.Le + this.He) / 2, (this.Xd + this.Vd) / 2)
        },
        kt: function (a) {
            if (!(a instanceof db) || Math.max(a.Le, a.He) < Math.min(this.Le, this.He) || Math.min(a.Le,
                    a.He) > Math.max(this.Le, this.He) || Math.max(a.Xd, a.Vd) < Math.min(this.Xd, this
                    .Vd) || Math.min(a.Xd, a.Vd) > Math.max(this.Xd, this.Vd)) return p;
        ...
        fs: function (a) {
            return !(a instanceof H) || this.xj() ? q : a.lng >= this.Le && a.lng <= this.He && a.lat >=
                this.Xd && a.lat <= this.Vd
        },
        extend: function (a) {
            if (a instanceof H) {
                var b = a.lng,
        ...
        LF: function () {
            return this.xj() ? new H(0, 0) : new H(Math.abs(this.He - this.Le), Math.abs(this.Vd - this
                .Xd))
        }
    });
    ...
    x.extend(S, {
        ...
        Eu: [75, 60, 45, 30, 15, 0],
        sP: [[1.410526172116255E-8, 8.98305509648872E-6, -1.9939833816331, 200.9824383106796, -
            187.2403703815547, 91.6087516669843, -23.38765649603339, 2.57121317296198, -
            0.03801003308653, 1.73379812E7], [-7.435856389565537E-9, 8.983055097726239E-6, -
            0.78625201886289, 96.32687599759846, -1.85204757529826, -59.36935905485877,
            ...
            0.32710905363475, 6856817.37], [-1.981981304930552E-8, 8.983055099779535E-6,
            0.03278182852591, 40.31678527705744, 0.65659298677277, -4.44255534477492,
            ...
            0.00466043876332, 2555164.4], [2.890871144776878E-9, 8.983055095805407E-6, -3.068298E-8,
            7.47137025468032, -3.53937994E-6, -0.02145144861037, -1.234426596E-5, 1.0322952773E-4,
        ...
        qG: [[-0.0015702102444, 111320.7020616939, 1704480524535203, -10338987376042340, 26112667856603880,
            ...
            9.133119359512032E8, 67.5], [0.00337398766765, 111320.7020202162, 4481351.045890365, -
            2.339375119931662E7, 7.968221547186455E7, -1.159649932797253E8, 9.723671115602145E7, -
            4.366194633752821E7, 8477230.501135234, 52.5], [0.00220636496208, 111320.7020209128,
            51751.86112841131, 3796837.749470245, 992013.7397791013, -1221952.21711287,
            1340652.697009075, -620943.6990984312, 144416.9293806241, 37.5], [-3.441963504368392E-4,
            111320.7020576856, 278.2353980772752, 2485758.690035394, 6070.750963243378,
        ...
        zb: function (a) {
            if (a === p || a === j || 180 < a.lng || -180 > a.lng || 90 < a.lat || -90 > a.lat) return new H(
                0, 0);
            var b, c;
            a.lng = this.OD(a.lng, -180, 180);
            a.lat = this.SD(a.lat, -74, 74);
        ...
        Te: function (a, b, c, d) {
            return this.mP * Math.acos(Math.sin(c) * Math.sin(d) + Math.cos(c) * Math.cos(d) * Math.cos(
                b - a))
        },
        Uk: function (a) {
    ...
    x.extend(S.prototype, {
        ...
        bc: function (a, b, c, d, e) {
            if (a) return a = this.Ck(a, e), b = this.yc(b), new R(Math.round((a.lng - c.lng) / b + d.width /
                2), Math.round((c.lat - a.lat) / b + d.height / 2))
        },
        wb: function (a, b, c, d, e) {
            if (a) return b = this.yc(b), this.nh(new H(c.lng + b * (a.x - d.width / 2), c.lat - b * (a
                .y - d.height / 2)), e)
        },
        yc: function (a) {
    ...
    x.extend(jc.prototype, {
        Ge: function (a) {
            if (!this.V && Xa(this.initialize) && (this.V = this.initialize(a))) this.V.style.WebkitUserSelect =
                "none";
            this.draw()
        },
        initialize: function () {
        ...
        jh: function () {
            return !this.V || "none" == this.V.style.display || "hidden" == this.V.style.visibility ? q :
                o
        }
    });
    z.We(function (a) {
    ...
    z.We(function (a) {
        ...
        a.addEventListener("clearoverlays", function () {
            ...
            a = 0;
            for (var d = b.De.length; a < d; a++) b.De[a].enableMassClear !== q && (b.De[a].remove(),
                b.De[a] = p, b.De.splice(a, 1), a--, d--)
        });
    ...
    x.extend(oc.prototype, {
        ...
        draw: function () {
            ...
            this.z.za = new L(-Math.round(this.z.width / 2) - Math.round(this.z.Tx), -Math.round(this.z
                .height / 2) - Math.round(this.z.Tx));
        ...
        SZ: function (a, b) {
            ...
            this.V && (this.V.style.width = this.z.width + "px", this.V.style.height = this.z.height +
                "px", this.draw())
        }
    });

    function pc(a, b, c) {
        a && b && (this.imageUrl = a, this.size = b, a = new L(Math.floor(b.width / 2), Math.floor(b.height / 2)),
            c = c || {}, a = c.anchor || a, b = c.imageOffset || new L(0, 0), this.imageSize = c.imageSize,
    ...
    function rc(a, b, c, d) {
        a && (this.Ev = {}, this.cL = d ? !!d : q, this.Uc = [], this.z_ = a instanceof qc ? a : p, this.HI = b ===
            j ? o : !!(b.indexOf("%") + 1), this.Zj = isNaN(parseFloat(b)) ? 1 : this.HI ? parseFloat(b) / 100 :
            parseFloat(b), this.II = !!(c.indexOf("%") + 1), this.repeat = c != j ? this.II ? parseFloat(c) /
            100 : parseFloat(c) : 0)
    };
    ...
    function sc(a, b) {
        ...
        if (0 != this.z.height && (60 > this.z.height && (this.z.height = 60), 650 < this.z.height)) this.z.height =
            650;
        if (0 != this.z.maxWidth && (220 > this.z.maxWidth && (this.z.maxWidth = 220), 730 < this.z.maxWidth)) this
            .z.maxWidth = 730;
        this.de = q;
        this.Di = F.qa;
        this.bb = p;
    ...
    function yc(a, b) {
        ...
        xc() && (a === j && ba(Error("\u6ca1\u6709\u4f20\u5165points\u6570\u636e")), "[object Array]" !== Object.prototype
            .toString.call(a) && ba(Error("points\u6570\u636e\u4e0d\u662f\u6570\u7ec4")), b = b || {}, eb.apply(
                c, arguments), c.ea = {
                ia: a
            }, c.z = {
                shape: b.shape || vc,
    ...
    x.extend(Bc.prototype, {
        ...
        hn: function (a, b) {
            this.so[a] && (this.so[a] = new H(b.lng, b.lat), this.ia[a] = new H(b.lng, b.lat), 0 == a &&
                !this.ia[0].nb(this.ia[this.ia.length - 1]) && (this.ia[this.ia.length - 1] = new H(
                    b.lng, b.lat)), this.Eh())
        },
        te: function () {
            var a = this.so;
    ...
    x.extend(Fc.prototype, {
        ...
        xf: function () {
            ...
            0 == this.ph && (this.Li && (clearTimeout(this.Li), this.Li = p), this.Li = setTimeout(
                function () {
                    if (a.ph == 0) {
        ...
        Cm: function (a, b, c) {
            ...
            l = 0;
            for (d = this.Qc.length; l < d; l++) A = this.Qc[l][0], i = this.Qc[l][1], t = A * e + g[0] -
                c / 2, v = (-1 - i) * e + g[1] - c / 2, y = k + "_" + b + "_" + A + "_" + i + "_" + f,
                m = this.Sm[y], n = p, m ? (n = m.style, n.left = t + "px", n.top = v + "px", m.$e ||
                    this.nn.push([A, i, m])) : (0 < this.Ne.length ? (m = this.Ne.shift(), m.getContext(
                        "2d").clearRect(-c / 2, -c / 2, w, w), n = m.style) : (m = document.createElement(
                            "canvas"), n = m.style, n.position = "absolute", n.width = e + c + "px", n.height =
                        e + c + "px", this.Px() && (n.WebkitTransform = "scale(1.001)"), m.setAttribute(
                            "width", w), m.setAttribute("height", w), a.appendChild(m)), m.id = y, n.left =
                    t + "px", n.top = v + "px", -1 < y.indexOf("bg") && (t = "#F3F1EC", this.map.D.Bo &&
                        (t = this.map.D.Bo), n.background = t ? t : ""), this.nn.push([A, i, m])), m.style
                .visibility = "";
            l = 0;
        ...
        o_: function (a, b, c, d) {
            ...
            k && k.Ib ? (ub(k.Ib, b), d && (d = new R(a[0], a[1]), f = this.map.D.xe ? this.map.D.xe.style :
                    "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Ic(k, d)), k.loaded ?
                this.xf() : Jc(k, function () {
                    e.xf()
                })) : (k = this.dj[g]) && k.Ib ? (c.Rb.insertBefore(k.Ib, c.Rb.lastChild), this.ug[
                    g] = k, ub(k.Ib, b), d && (d = new R(a[0], a[1]), f = this.map.D.xe ? this.map.D
                    .xe.style : "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, Ic(k, d)), k
                .loaded ? this.xf() : Jc(k, function () {
                    e.xf()
                })) : (k = i * Math.pow(2, f.vm() - a[2]), new H(a[0] * k, a[1] * k), d = new R(a[0],
                a[1]), f = this.map.D.xe ? this.map.D.xe.style : "normal", d = c.getTilesUrl(d,
                a[2], f), k = new Kc(this, d, b, a, c), Jc(k, function () {
                e.xf()
            }), k.ao(), this.ug[g] = k)
        },
        xf: function () {
        ...
        XD: function (a, b) {
            return this.map.oa() === Pa ? "TILE-" + b.ba + "-" + this.map.Hw + "-" + a[0] + "-" + a[1] +
                "-" + a[2] : "TILE-" + b.ba + "-" + a[0] + "-" + a[1] + "-" + a[2]
        },
        Hx: function (a) {
            var b = a.Ib;
        ...
        Bw: function (a, b) {
            for (var c = 0, d = 6 * Math.pow(2, b - 3), e = d / 2 - 1, f = -d / 2; a > e;) a -= d, c -=
                this.PA;
        ...
        rV: function (a, b) {
            for (var c = 256 * Math.pow(2, 18 - b), d = Math.floor(this.kI / c), e = Math.floor(this.lI /
                    c), c = Math.floor(this.PA / c), f = [], g = 0; g < a.length; g++) {
                var i = a[g],
                    k = i[0],
                    i = i[1];
                if (k >= d) {
                ...
                } else k <= e && (k -= c, l = "id_" + k + "_" + i + "_" + b, a[l] || (a[l] = o, f.push(
                    [k, i])))
            }
            ...
            for (var g = 0; g < c; g++) {
                ...
                if (i.zw) {
                    ...
                    if (a) {
                        var l = k;
                        if (l && l.childNodes)
                            for (var m = l.childNodes.length, n = m - 1; 0 <= n; n--) m = l.childNodes[
                    ...
                    if (this.map.Wb()) {
                        ...
                        continue
                    } else k.style.display = "block", this.ld.style.display = "none", this.map.dispatchEvent(
                        new M("vectorchanged"), {
                            isvector: q
                        })
                }
                if (!i.bI && !(i.qp && !this.map.Wb() || i.mM && this.map.Wb())) {
                    ...
                    for (A in B) {
                        var E = B[A],
                            C = E.info;
                        (C[2] != f || C[2] == f && (n > C[0] || v <= C[0] || l > C[1] || e <= C[1])) &&
                        this.Hx(E)
                    }
                    B = -d.offsetX + d.width / 2;
                    E = -d.offsetY + d.height / 2;
                    i.Rb && (i.Rb.style.left = Math.ceil(w + B) - t[0] + "px", i.Rb.style.top = Math.ceil(
                        y + E) - t[1] + "px", i.Rb.style.WebkitTransform = "translate3d(0,0,0)");
                    w = [];
                    for (d.MB = []; n < v; n++)
        ...
        wh: function (a) {
            ...
            if (a instanceof bb) b && a.Im && (a.remove(), a.Im = q);
                ...
                if (a.qp)
                    for (var b = 0, c = this.Bg.length; b < c; b++) a == this.Bg[b] && this.Bg.splice(b,
                        1);
                else {
                    b = 0;
        ...
        Tt: function (a) {
            ...
            if (!this.map.Wb() && (a ? this.map.D.w_ = a : a = this.map.D.w_, a))
                for (var c = p, c = "2" == z.Qy ? [z.url.proto + z.url.domain.main_domain_cdn.other[0] +
                        "/"] : [z.url.proto + z.url.domain.main_domain_cdn.baidu[0] + "/", z.url.proto +
                        z.url.domain.main_domain_cdn.baidu[1] + "/", z.url.proto + z.url.domain.main_domain_cdn
                        .baidu[2] + "/"], d = 0, e; e = this.Mm[d]; d++)
                    if (e.j_ == o) {
                        b.k.$b = 18;
                        e.getTilesUrl = function (b, d) {
                            var e = b.x,
                                ...
                                m = 1;
                            this.map.Ix() && (m = 2);
                            l = "customimage/tile?&x=" + e + "&y=" + k + "&z=" + d + "&udt=" + l +
                                "&scale=" + m + "&ak=" + pa;
                            l = a.styleStr ? l + ("&styles=" + encodeURIComponent(a.styleStr)) : l +
                                ("&customid=" + a.style);
    ...
    x.extend(Gc.prototype, {
        ...
        remove: function () {
            this.Rb && this.Rb.parentNode && (this.Rb.innerHTML = "", this.Rb.parentNode.removeChild(
                this.Rb));
            delete this.Rb
        },
        vt: u("V_"),
        getTilesUrl: function (a, b) {
            ...
            var d = "";
            this.qh.tileUrlTemplate && (d = this.qh.tileUrlTemplate.replace(/\{X\}/, c), d = d.replace(
                /\{Y\}/, a.y), d = d.replace(/\{Z\}/, b));
            return d
        },
        sm: u("LV"),
        oa: function () {
    ...
    function bb(a) {
        this.pV = [z.url.proto + z.url.domain.TILE_ONLINE_URLS[1] + "/gvd/?", z.url.proto + z.url.domain.TILE_ONLINE_URLS[
                2] + "/gvd/?", z.url.proto + z.url.domain.TILE_ONLINE_URLS[3] + "/gvd/?", z.url.proto + z.url.domain
            .TILE_ONLINE_URLS[4] + "/gvd/?"];
        this.k = {
            bL: q
        };
    ...
    lb.prototype.getTilesUrl = function (a, b) {
        var c = a.x,
            d = a.y,
            e = this.pc,
            c = Rc[Math.abs(c + d) % Rc.length] + "/image?grids=" + c + "_" + d + "_" + b + "&q=" + e.Ym +
            "&tags=" + e.ju + "&filter=" + e.filter + "&sortby=" + e.Jy + "&ak=" + this.pc.Vl + "&age=" + e.ww +
            "&page_size=" + e.wN + "&format=" + e.E_;
    ...
    var Vc = [z.url.proto + z.url.domain.TILE_BASE_URLS[0] + "/it/", z.url.proto + z.url.domain.TILE_BASE_URLS[1] +
        ...
        Wc = [z.url.proto + z.url.domain.TILE_ONLINE_URLS[0] + "/tile/", z.url.proto + z.url.domain.TILE_ONLINE_URLS[
    ...
    Yc.getTilesUrl = function (a, b, c) {
        ...
        return (Wc[Math.abs(d + a) % Wc.length] + "?qt=vtile&x=" + (d + "").replace(/-/gi, "M") + "&y=" + (a +
            "").replace(/-/gi, "M") + "&z=" + b + "&styles=" + c + "&scaler=" + f + (6 == x.da.la ?
            "&color_dep=32&colors=50" : "") + "&udt=" + e).replace(/-(\d+)/gi, "M$1")
    };
    var La = new Uc("\u5730\u56fe", Yc, {
            tips: "\u663e\u793a\u666e\u901a\u5730\u56fe",
            maxZoom: 19
        ...
        Zc = new Gc;
    Zc.rO = [z.url.proto + z.url.domain.TIlE_PERSPECT_URLS[0] + "/resource/mappic/", z.url.proto + z.url.domain.TIlE_PERSPECT_URLS[
    ...
    Zc.getTilesUrl = function (a, b) {
        ...
        return url = this.rO[Math.abs(c + d) % this.rO.length] + this.map.Xb + "/" + this.map.Hw + "/3/lv" + (
            21 - b) + "/" + c + "," + d + ".jpg"
    };
    var Pa = new Uc("\u4e09\u7ef4", Zc, {
        tips: "\u663e\u793a\u4e09\u7ef4\u5730\u56fe",
    ...
    $c.getTilesUrl = function (a, b) {
        var c = a.x,
            d = a.y;
        return (Vc[Math.abs(c + d) % Vc.length] + "u=x=" + c + ";y=" + d + ";z=" + b +
            ";v=009;type=sate&fm=46&udt=" + Qb("satellite")).replace(/-(\d+)/gi, "M$1")
    };
    var Ya = new Uc("\u536b\u661f", $c, {
            tips: "\u663e\u793a\u536b\u661f\u5f71\u50cf",
            minZoom: 1,
    ...
    ad.getTilesUrl = function (a, b) {
        ...
        return (Wc[Math.abs(c + d) % Wc.length] + "?qt=vtile&x=" + (c + "").replace(/-/gi, "M") + "&y=" + (d +
            "").replace(/-/gi, "M") + "&z=" + b + "&styles=sl" + (6 == x.da.la ?
            "&color_dep=32&colors=50" : "") + "&udt=" + e).replace(/-(\d+)/gi, "M$1")
    };
    ...
    function W(a, b) {
        ...
        this.k.ka.Wg = "undefined" != typeof b && "undefined" != typeof b.renderOptions && "undefined" != typeof b.renderOptions
    ...
    x.extend(td.prototype, {
        ...
        TV: function () {
            ...
            if (this.page < this.Uf) d = 0 == this.page % this.Uf ? this.page - this.Uf - 1 : this.page -
                this.page % this.Uf + 1, b = d + this.Uf - 1;
            else {
            ...
            this.page > this.Jd - this.Uf && this.page >= this.Uf && (d = this.Jd - this.Uf + 1, b =
                this.Jd);
            for (e = d; e <= b; e++) 0 < e && (e == this.page ? a.push(
                    '<span style="margin-right:3px">' + e + "</span>") : 1 <= e && e <= this.Jd &&
                (d =
                    '<span><a style="color:#7777cc;margin-right:3px" href="javascript:void(0)" onclick="{temp3}">[' +
                    e + "]</a></span>", a.push(d.replace("{temp3}", "BMap.I('" + this.ba +
                        "').toPage(" + e + ");"))));
            c > this.Jd || a.push(
    ...
    function Na(a, b) {
        function c() {
            e.k.visible ? ("inter" === e.Je && e.k.haveBreakId && e.k.indoorExitControl === o ? x.K.show(e.wA) : x.K
                .U(e.wA), this.k.closeControl && this.yf && this.C && this.C.La() === this.B ? x.K.show(e.yf) :
                x.K.U(e.yf), this.k.forceCloseControl && x.K.show(e.yf)) : (x.K.U(e.yf), x.K.U(e.wA))
        }
        ...
        this.Og = [];
        this.yr = [];
        "cvsRender" == this.ck || Ma() ? (this.Vj = 90, this.Xj = -90) : "cssRender" == this.ck && (this.Vj = 45,
            this.Xj = -45);
        this.Cr = q;
        var e = this;
        this.ao = function () {
    ...
    x.extend(Na.prototype, {
        ...
        rc: function (a, b, c) {
            ...
            a != this.Ya && (this.rl = this.Ya, this.sl = this.Mb, this.Ya = a, this.Je = b || "street",
                this.Mb = p, c && c.pov && this.Mc(c.pov))
        },
        ta: function (a) {
            a.nb(this.Mb) || (this.rl = this.Ya, this.sl = this.Mb, this.Mb = a, this.Ya = p)
        },
        Mc: function (a) {
            a && (this.Da = a, a = this.Da.pitch, a > this.Vj ? a = this.Vj : a < this.Xj && (a = this.Xj),
                this.Cr = o, this.Da.pitch = a)
        },
        e_: function (a, b) {
            this.Xj = 0 <= a ? 0 : a;
            this.Vj = 0 >= b ? 0 : b
        ...
        Nc: function (a) {
            a != this.Jc && (a > Md && (a = Md), a < Nd && (a = Nd), a != this.Jc && (this.Jc = a),
                "cssRender" === this.ck && this.Mc(this.Da))
        },
        wB: function () {
            if (this.C)
                for (var a = this.C.wx(), b = 0; b < a.length; b++)(a[b] instanceof U || a[b] instanceof tc) &&
        ...
        cr: function () {
            return Ua() && !G() && "javascript" !== this.k.panoramaRenderer ? "flashRender" : !G() &&
                Kb() ? "cvsRender" : "cssRender"
        },
        Ka: function (a) {
            this.Ie[a.hd] = a
        },
                    ...
                    if (a.id != b.Yv) {
                        ...
                        if (b.sl) {
                            ...
                            var i = g.lat,
                                k = Nb(i - c),
                                f = Nb(g.lng - f.lng);
                            c = Math.sin(k / 2) * Math.sin(k / 2) + Math.cos(Nb(c)) * Math.cos(Nb(i)) *
    ...
    ac.prototype.getTilesUrl = function (a, b) {
        var c = ac.zG[(a.x + a.y) % ac.zG.length] + "?udt=20150114&qt=tile&styles=pl&x=" + a.x + "&y=" + a.y +
            "&z=" + b;
    ...
    var je = ee ? "-" + ee.toLowerCase() + "-" : "",
        ...
        Je = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame ||
        window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (a) {
            return setTimeout(a, 1)
        },
        Ke = window.cancelRequestAnimationFrame || window.O4 || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame ||
    ...
    Me.prototype = {
        ...
        uQ: function () {
            !this.oh && (!this.Yk && !(this.Yl || this.yy == this.Pb.offsetWidth * this.scale && this.Kp ==
                this.Pb.offsetHeight * this.scale)) && this.refresh()
        },
        Iv: function (a) {
            var b;
            this[a + "Scrollbar"] ? (this[a + "ScrollbarWrapper"] || (b = be.createElement("div"), this.options
                    .kF ? b.className = this.options.kF + a.toUpperCase() : b.style.cssText =
                    "position:absolute;z-index:100;" + ("h" == a ?
                        "height:7px;bottom:1px;left:2px;right:" + (this.Bi ? "7" : "2") + "px" :
                        "width:7px;bottom:" + (this.mi ? "7" : "2") + "px;top:2px;right:1px"), b.style.cssText +=
                    ";pointer-events:none;" + je + "transition-property:opacity;" + je +
                    "transition-duration:" + (this.options.GW ? "350ms" : "0") +
                    ";overflow:hidden;opacity:" + (this.options.Gx ? "0" : "1"), this.xn.appendChild(b),
                    this[a + "ScrollbarWrapper"] = b, b = be.createElement("div"), this.options.kF || (
                        b.style.cssText =
                        "position:absolute;z-index:100;background:rgba(0,0,0,0.5);border:1px solid rgba(255,255,255,0.9);" +
                        je + "background-clip:padding-box;" + je + "box-sizing:border-box;" + ("h" == a ?
                            "height:100%" : "width:100%") + ";" + je +
                        "border-radius:3px;border-radius:3px"), b.style.cssText +=
                    ";pointer-events:none;" + je + "transition-property:" + je + "transform;" + je +
                    "transition-timing-function:cubic-bezier(0.33,0.66,0.66,1);" + je +
                    "transition-duration:0;" + je + "transform: translate(0,0)" + Le, this.options.Ai &&
                    (b.style.cssText += ";" + je +
                ...
                a ? (this.OL = this.PL.clientWidth, this.VX = ce.max(ce.round(this.OL * this.OL / this.yy),
                    8), this.UX.style.width = this.VX + "px") : (this.NO = this.OO.clientHeight, this.c0 =
                    ce.max(ce.round(this.NO * this.NO / this.Kp), 8), this.b0.style.height = this.c0 +
                    "px"), this.qB(a, o)) : this[a + "ScrollbarWrapper"] && (Be && (this[a +
                "ScrollbarIndicator"].style[le] = ""), this[a + "ScrollbarWrapper"].parentNode.removeChild(
        ...
        Br: function (a, b) {
            this.Yk || (a = this.jp ? a : 0, b = this.vn ? b : 0, this.options.Vk ? this.Pb.style[le] =
                "translate(" + a + "px," + b + "px) scale(" + this.scale + ")" + Le : (a = ce.round(a),
                    b = ce.round(b), this.Pb.style.left = a + "px", this.Pb.style.top = b + "px"), this
                .x = a, this.y = b, this.qB("h"), this.qB("v"))
        },
        qB: function (a, b) {
            var c = "h" == a ? this.x : this.y;
            this[a + "Scrollbar"] && (c *= this[a + "ScrollbarProp"], 0 > c ? (this.options.rD || (c = this[
                    a + "ScrollbarIndicatorSize"] + ce.round(3 * c), 8 > c && (c = 8), this[a +
                    "ScrollbarIndicator"].style["h" == a ? "width" : "height"] = c + "px"), c = 0) : c >
                this[a + "ScrollbarMaxScroll"] && (this.options.rD ? c = this[a + "ScrollbarMaxScroll"] :
                    (c = this[a + "ScrollbarIndicatorSize"] - ce.round(3 * (c - this[a +
                    ...
                    "ScrollbarWrapper"].style[we] = "0", this[a + "ScrollbarWrapper"].style.opacity = b &&
                this.options.Gx ? "0" : "1", this[a + "ScrollbarIndicator"].style[le] = "translate(" +
                ("h" == a ? c + "px,0)" : "0," + c + "px)") + Le)
        },
        FQ: function (a) {
            ...
            if ("select" != b && "input" != b && "textarea" != b) return a.stopImmediatePropagation ? a.stopImmediatePropagation() :
                a.mZ = o, a.stopPropagation(), a.preventDefault(), this.fx = this.OB = p, q
        },
        Rv: function (a) {
            ...
            if (this.enabled) {
                ...
                this.options.zoom && (Ae && 1 < a.touches.length) && (d = ce.abs(a.touches[0].pageX - a.touches[
                    1].pageX), c = ce.abs(a.touches[0].pageY - a.touches[1].pageY), this.K_ = ce.sqrt(
                    d * d + c * c), this.gy = ce.abs(a.touches[0].pageX + a.touches[1].pageX - 2 *
                    this.VF) / 2 - this.x, this.hy = ce.abs(a.touches[0].pageY + a.touches[1].pageY -
                    2 * this.WF) / 2 - this.y, this.options.Ap && this.options.Ap.call(this, a));
                if (this.options.Yx && (this.options.Vk ? (c = getComputedStyle(this.Pb, p)[le].replace(
                            /[^0-9\-.,]/g, "").split(","), d = +(c[12] || c[4]), c = +(c[13] || c[5])) : (d = +
                            getComputedStyle(this.Pb, p).left.replace(/[^0-9-]/g, ""), c = +
                            getComputedStyle(this.Pb, p).top.replace(/[^0-9-]/g, "")), d != this.x || c !=
                        this.y)) this.options.Ai ? this.Yd(Ie) : Ke(this.WB), this.Aj = [], this.Br(d, c),
        ...
        dT: function (a) {
            ...
            if (this.options.zoom && Ae && 1 < a.touches.length) e = ce.abs(a.touches[0].pageX - a.touches[
                    1].pageX), f = ce.abs(a.touches[0].pageY - a.touches[1].pageY), this.J_ = ce.sqrt(e * e +
                    f * f), this.Yk = o, b = 1 / this.K_ * this.J_ * this.scale, b < this.options.Xk ? b =
                0.5 * this.options.Xk * Math.pow(2, b / this.options.Xk) : b > this.options.aq && (b = 2 *
                    this.options.aq * Math.pow(0.5, this.options.aq / b)), this.up = b / this.scale, e =
                this.gy - this.gy * this.up + this.x, f = this.hy - this.hy * this.up + this.y, this.Pb.style[
                    le] = "translate(" + e + "px," + f + "px) scale(" + b + ")" + Le, this.options.oN &&
                this.options.oN.call(this, a);
            else {
                this.rh = b.pageX;
                this.th = b.pageY;
                if (0 < e || e < this.he) e = this.options.Do ? this.x + c / 2 : 0 <= e || 0 <= this.he ? 0 :
                    this.he;
                if (f > this.qf || f < this.nd) f = this.options.Do ? this.y + d / 2 : f >= this.qf || 0 <=
                    this.nd ? this.qf : this.nd;
                this.NC += c;
                this.OC += d;
                this.jw = ce.abs(this.NC);
                this.kw = ce.abs(this.OC);
                6 > this.jw && 6 > this.kw || (this.options.DE && (this.jw > this.kw + 5 ? (f = this.y, d =
                        0) : this.kw > this.jw + 5 && (e = this.x, c = 0)), this.oh = o, this.Br(e, f),
                    this.HC = 0 < c ? -1 : 0 > c ? 1 : 0, this.IC = 0 < d ? -1 : 0 > d ? 1 : 0, 300 < g -
                    this.startTime && (this.startTime = g, this.gu = this.x, this.hu = this.y), this.options
                    .lN && this.options.lN.call(this, a))
            }
        },
        cv: function (a) {
            if (!(Ae && 0 !== a.touches.length)) {
                ...
                if (b.Yk) d = b.scale * b.up, d = Math.max(b.options.Xk, d), d = Math.min(b.options.aq, d),
                    b.up = d / b.scale, b.scale = d, b.x = b.gy - b.gy * b.up + b.x, b.y = b.hy - b.hy * b.up +
                    b.y, b.Pb.style[oe] = "200ms", b.Pb.style[le] = "translate(" + b.x + "px," + b.y +
                    "px) scale(" + b.scale + ")" + Le, b.Yk = q, b.refresh(), b.options.zp && b.options.zp.call(
                        b, a);
                else {
                    if (b.oh) {
                        if (300 > i && b.options.Yx) {
                            f = d ? b.nI(d - b.gu, i, -b.x, b.yy - b.vu + b.x, b.options.Do ? b.vu : 0) : f;
                            g = e ? b.nI(e - b.hu, i, -b.y, 0 > b.nd ? b.Kp - b.yn + b.y - b.qf : 0, b.options
                                .Do ? b.yn : 0) : g;
                            d = b.x + f.Ba;
                            e = b.y + g.Ba;
                        ...
                        f.Ba || g.Ba ? (c = ce.max(ce.max(f.time, g.time), 10), b.options.du && (f = d - b.lw,
                            g = e - b.mw, ce.abs(f) < b.options.Iy && ce.abs(g) < b.options.Iy ? b.scrollTo(
                                b.lw, b.mw, 200) : (f = b.hJ(d, e), d = f.x, e = f.y, c = ce.max(f.time,
                                c))), b.scrollTo(ce.round(d), ce.round(e), c)) : b.options.du ? (f = d -
                            b.lw, g = e - b.mw, ce.abs(f) < b.options.Iy && ce.abs(g) < b.options.Iy ?
                            b.scrollTo(b.lw, b.mw, 200) : (f = b.hJ(b.x, b.y), (f.x != b.x || f.y != b.y) &&
                                b.scrollTo(f.x, f.y, f.time))) : b.jo(200)
                    } else {
                        if (Ae)
                            if (b.GK && b.options.zoom) clearTimeout(b.GK), b.GK = p, b.options.Ap && b.options
                                .Ap.call(b, a), b.zoom(b.rh, b.th, 1 == b.scale ? b.options.nW : 1), b.options
                                .zp && setTimeout(function () {
                                    b.options.zp.call(b, a)
                                }, 200);
                            else if (this.options.Cx) {
                            for (d = c.target; 1 != d.nodeType;) d = d.parentNode;
                            e = d.tagName.toLowerCase();
                            "select" != e && "input" != e && "textarea" != e ? (e = be.createEvent(
                                "MouseEvents"), e.initMouseEvent("click", o, o, a.view, 1, c.screenX,
                                c.screenY, c.clientX, c.clientY, a.ctrlKey, a.altKey, a.shiftKey, a
                                .metaKey, 0, p), e.BR = o, d.dispatchEvent(e)) : d.focus()
                        }
                        b.jo(400)
                    }
        ...
        jo: function (a) {
            ...
            if (b == this.x && c == this.y) {
                if (this.oh && (this.oh = q, this.options.ey && this.options.ey.call(this)), this.mi &&
                    this.options.Gx && ("webkit" == ee && (this.PL.style[we] = "300ms"), this.PL.style.opacity =
                        "0"), this.Bi && this.options.Gx) "webkit" == ee && (this.OO.style[we] = "300ms"),
        ...
        HU: function (a) {
            ...
            if ("zoom" == b.options.WO) {
                if (d = b.scale * Math.pow(2, 1 / 3 * (d ? d / Math.abs(d) : 0)), d < b.options.Xk && (d =
                        b.options.Xk), d > b.options.aq && (d = b.options.aq), d != b.scale) !b.Sy && b.options
                    .Ap && b.options.Ap.call(b, a), b.Sy++, b.zoom(a.pageX, a.pageY, d, 400), setTimeout(
                        function () {
                            b.Sy--;
                            !b.Sy && b.options.zp && b.options.zp.call(b, a)
                        }, 400)
            } else c = b.x + c, d = b.y + d, 0 < c ? c = 0 : c < b.he && (c = b.he), d > b.qf ? d = b.qf :
                d < b.nd && (d = b.nd), 0 > b.nd && b.scrollTo(c, d, 0)
        },
        DU: function (a) {
        ...
        CB: function () {
            var a = this,
                ...
                d = Date.now(),
                e, f, g;
            a.Yl || (a.Aj.length ? (e = a.Aj.shift(), e.x == b && e.y == c && (e.time = 0), a.Yl = o, a.oh =
                o, a.options.Ai) ? (a.qJ(e.time), a.Br(e.x, e.y), a.Yl = q, e.time ? a.ca(Ie) : a.jo(
                0)) : (g = function () {
                var i = Date.now(),
                    k;
                if (i >= d + e.time) {
        ...
        refresh: function () {
            ...
            if ("string" == typeof this.options.du) {
                ...
                a = 0;
                for (b = c.length; a < b; a++) d = this.Zj(c[a]), d.left += this.VF, d.top += this.WF, this
                    .Ue[a] = d.left < this.he ? this.he : d.left * this.scale, this.sf[a] = d.top < this.nd ?
                    this.nd : d.top * this.scale
            } else if (this.options.du) {
                for (this.Ue = []; d >= this.he;) this.Ue[b] = d, d -= this.vu, b++;
                this.he % this.vu && (this.Ue[this.Ue.length] = this.he - this.Ue[this.Ue.length - 1] +
                    this.Ue[this.Ue.length - 1]);
                b = d = 0;
                for (this.sf = []; d >= this.nd;) this.sf[b] = d, d -= this.yn, b++;
                this.nd % this.yn && (this.sf[this.sf.length] = this.nd - this.sf[this.sf.length - 1] +
        ...
        zoom: function (a, b, c, d) {
            var e = c / this.scale;
            this.options.Vk && (this.Yk = o, d = d === j ? 200 : d, a = a - this.VF - this.x, b = b - this.WF -
                this.y, this.x = a - a * e + this.x, this.y = b - b * e + this.y, this.scale = c, this.refresh(),
                this.x = 0 < this.x ? 0 : this.x < this.he ? this.he : this.x, this.y = this.y > this.qf ?
                this.qf : this.y < this.nd ? this.nd : this.y, this.Pb.style[oe] = d + "ms", this.Pb.style[
                    le] = "translate(" + this.x + "px," + this.y + "px) scale(" + c + ")" + Le, this.Yk =
                q)
        }
    };
    ...
    z.Um(function (a) {
        ...
        a.addEventListener("albums_visible_changed", function () {
            a.k.albumsControl === o ? (b ? b.qy(a.Zb()) : (b = new Ne(a.k.albumsControlOptions), b.ra(
                a)), b.show()) : b.U()
        });
        ...
        a.addEventListener("visible_changed", function () {
            b && (a.$D() ? a.k.albumsControl === o && (b.B.style.visibility = "visible") : b.B.style
                .visibility = "hidden")
        })
    });
    var Oe = 1.8;
    ...
    x.extend(Ne.prototype, {
        Mk: function (a) {
            ...
            this.qc(this.k.anchor);
            this.B.style.width = isNaN(Number(this.k.maxWidth)) === o ? this.k.maxWidth : this.k.maxWidth +
                "px";
        ...
        qy: function (a, b) {
            if (b || !this.$j[this.Xc] || !(this.$j[this.Xc].panoId == a && 3 !== this.$j[this.Xc].recoType)) {
                var c = this,
                    d = this.EH(a);
                !b && -1 !== d && this.$j[d] && 3 !== this.$j[d].recoType ? this.Op(d) : this.AX(
                    function (a) {
                        for (var b = {}, d, i, k = q, l = [], m = 0, n = a.length; m < n; m++) d =
                            a[m].catlog, i = a[m].floor, j !== d && ("" === d && j !== i ? (k = o,
                                b[i] || (b[i] = []), b[i].push(a[m])) : (b[Pe[d]] || (b[Pe[d]] = []),
                                b[Pe[d]].push(a[m])));
        ...
        RV: function () {
            if (this.Ki) a = this.mL(this.Ni), this.tQ.innerHTML = a;
                ...
                x.M(b, "click", function (a) {
                    if (a = (a.srcElement || a.target).getAttribute("dataindex")) {
                        ...
                        for (var d = b.getElementsByTagName("li"), e = 0, f = d.length; e < f; e++)
                            d[e].childNodes[0].getAttribute("dataindex") === a ? x.K.Ua(d[e],
                                "pano_catlogLiActive") : x.K.Tb(d[e], "pano_catlogLiActive")
                    }
                });
                var a = K("div"),
                    d = K("a"),
                ...
                a.appendChild(f);
                d = K("div");
                d.style.cssText = ["position:absolute;z-index:2001;left:20px;", "height:" + this.k.imageHeight +
                    "px;",
        ...
        SV: function () {
            if (this.Ni && !(0 >= this.Ni.length)) {
                ...
                this.Ki && (this.Ki.style.left = parseInt(this.Ki.style.left, 10) + this.dg.width + 8 +
                    "px");
                var b = this;
        ...
        Gl: function (a) {
            this.$j = a;
            this.k.showCatalog && (0 < this.Ni.length ? (Ua() ? this.RV() : this.UV(), this.Oc.offsetLeft =
                60) : (this.Ks && (this.B.removeChild(this.Ks), this.Ks = p, this.Oc.eg.style.left =
                    "0px"), this.Ki && (this.B.removeChild(this.Ki), this.Ki = p), this.Oc.offsetLeft =
                0));
            var b = this.iX(a);
            Ua() && (this.Ni && 0 < this.Ni.length && this.k.showExit && this.Zz) && (this.Oc.offsetLeft +=
                this.dg.width + 8, this.Ks ? this.Ks.innerHTML = this.Zz : this.SV());
            this.Wh.innerHTML = b;
            this.Wh.style.width = (this.dg.width + 8) * a.length + 8 + "px";
            a = this.B.offsetWidth;
            b = this.Wh.offsetWidth;
            this.Oc.Rs && (b += this.Oc.Rs());
            b < a - 2 * this.Oc.Ei - this.Oc.offsetLeft ? this.B.style.width = b + this.Oc.offsetLeft +
                "px" : (this.B.style.width = isNaN(Number(this.k.maxWidth)) === o ? this.k.maxWidth :
                    this.k.maxWidth + "px", b < this.B.offsetWidth - 2 * this.Oc.Ei - this.Oc.offsetLeft &&
        ...
        iX: function (a) {
            for (var b, c, d, e, f = [], g = this.dg.height, i = this.dg.width, k = 0; k < a.length; k++)
                b = a[k], recoType = b.recoType, d = b.panoId, e = b.name, c = b.heading, b = b.pitch,
                c = ae.yL(d, c, b, 198, 108), b =
                ...
                'px;"><em class="pano_poi_' + recoType + '"></em>' + e + "</span></a>", 3 === recoType ?
                Ua() ? (this.Zz = b, this.DW = d, a.splice(k, 1), k--) : (b =
                    '<a href="javascript:void(0);" class="pano_photo_item" data-index="' + k +
                    '"><img style="width:' + (i - 2) + "px;height:" + (g - 2) + 'px;" data-index="' + k +
                    '" name="' + e + '" src="' + c + '" alt="' + e +
        ...
        bQ: function () {
            ...
            x.M(this.fk, "click", function (b) {
                if ((b = (b.srcElement || b.target).getAttribute("data-index")) && b != a.Xc) a
                    .Op(b), a.P.rc(a.$j[b].panoId)
            });
    ...
    Re.prototype = {
        ...
        refresh: function () {
            ...
            this.eg && (this.eg.children[0].style.marginTop = this.Hr.children[0].style.marginTop = this.eg
                .offsetHeight / 2 - this.eg.children[0].offsetHeight / 2 + "px")
        },
        Rs: function () {
            return 2 * this.Ei
        },
        hs: function () {
            ...
            this.eg.children[0].style.marginTop = this.Hr.children[0].style.marginTop = this.eg.offsetHeight /
                2 - this.eg.children[0].offsetHeight / 2 + "px"
        },
        am: function () {
            var a = this;
        ...
        scrollTo: function (a) {
            a = a < this.Rg.offsetLeft ? Math.ceil((a - this.Ei - this.eo) / this.Pr) * this.Pr + this.eo +
                this.Ei - 8 : Math.ceil((a - this.Ei) / this.Pr) * this.Pr + this.Ei;
